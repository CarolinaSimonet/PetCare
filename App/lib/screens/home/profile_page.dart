        ...
        child: SingleChildScrollView(
          child: Center(
            child: Column(
              children: [
                CircleAvatar(
                  backgroundImage: const AssetImage('assets/michaelS.JPG'),
                  radius: 60,
                  child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: (){},
                        icon: Icon(Icons.camera_alt, size: 35, color: Colors.brown.shade800,),
                      )
                  ),
                ),
                myInfo(context),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(onPressed: (){}, icon: Icon(Icons.edit, color: Colors.brown.shade800,))
                        ],
                      ),
                    ],
                  ),
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Colors.brown.shade800, fontFamily: 'Inter'),
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    foregroundColor: Colors.white, backgroundColor: Colors.brown.shade800,
                    textStyle: const TextStyle(fontSize: 15, fontFamily: 'Inter', fontWeight: FontWeight.w700),
                    elevation: 0,
